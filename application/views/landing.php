        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="text-center">
                        <h1 class="p-5">(Re)Bonjour, <?php echo $utilisateur['pseudo']; ?></h1>
                        <hr />
                        <a href=<?php echo base_url('utilisateur/logout'); ?> class="btn btn-danger btn-lg">Déconnexion</a>
                        <a href=<?php echo base_url('welcome'); ?> class="btn btn-dark btn-lg">Accueil</a>
